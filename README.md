...
## Limitations
Has only been confirmed to work on the Arduino Nano 33 iot Board. But it should work on any of the samd Arduino boards that come with built on wifi module (like the new rp2040connect or mkrwifi1010 board)
