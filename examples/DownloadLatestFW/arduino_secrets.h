...
Print *debugPort = &Serial;               //change to change where debug messages go, could be any stream, e.g Serial, Serial1, WifiClient, (untested Sd file)
...
const char DEVICE[]= "Arduino NANO 33 IoT";//inseerted as userbagent for the http request
